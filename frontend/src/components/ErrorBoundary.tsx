...
// Props interface: component may accept children.
interface Props {
  children?: ReactNode;
}

// State interface: holds the error state.
interface State {
  hasError: boolean;
}

// Global declaration to add the __COMPONENT_ERROR__ method to the Window object.
declare global {
  interface Window {
...
class ErrorBoundary extends Component<Props, State> {
  ...
  // Catches error details and logs them.
  public componentDidCatch(error: Error, errorInfo: ErrorInfo) {
    // Cast to 'any' because this property isn't on the standard Error type.
    (error as any).__ErrorBoundary = true;

    // Call the window method using optional chaining.
